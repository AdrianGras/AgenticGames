...
from ui_layer.gradio.game_session.input_views.mystery_sequences_input_view import MysterySequencesInputView
...
INPUT_UIs: Dict[str, Type[SignalEmitter]] = {
    "mystery_sequences": MysterySequencesInputView
}
